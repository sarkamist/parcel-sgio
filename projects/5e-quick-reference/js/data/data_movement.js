data_movement = [
    ...
    },
    {
        ...
        bullets: [
            ...
            "To move while prone, you must <a href='crawl'>crawl</a> or use magic such as teleportation.",
            "Dropping prone adds the <a href='prone'>prone</a> condition (melee attacks against you have advantage, ranged attacks against you have disadvantage, your own attacks have disadvantage)."
        ]
    },
    {
        title: "Crawl",
    ...
    },
    {
        ...
        bullets: [
            ...
            "May involve a DC 10 Dexterity (Acrobatics) check to land on your feet in difficult terrain. You land <a href='prone'>prone</a> on a failed check."
        ]
    },
    {
        title: "Improvise",
    ...
    },
    {
        ...
        bullets: [
            ...
            "See the attack action for how to <a href='grapple'>grapple</a> a creature."
        ]
    },
    {
        ...
        bullets: [
            "Once during your move, you can mount a creature that is within 5 feet of you or dismount. Doing so costs an amount of movement equal to half your speed. For example, if your speed is 30 feet, you must spend 15 feet of movement to mount a horse. Therefore, you can't mount it if you don't have 15 feet of movement left or if your speed is O. If an effect moves your mount against its will while you're on it, you must succeed on a DC 10 Dexterity saving throw or fall off the mount, landing <a href='prone'>prone</a> in a space within 5 feet of it.",
            "If you're knocked <a href='prone'>prone</a> while mounted, you must make the same saving throw. If your mount is knocked <a href='prone'>prone</a>, you can use your reaction to dismount it as it falls and land on your feet. Otherwise, you are dismounted and fall <a href='prone'>prone</a> in a space within 5 feet it."
        ]
    }
];
